...
const Carousel = () => {
  ...
  return (
    <div className="carousel-container">
      <div className="carousel-wrapper" style={transformStyle}>
        <div className="carousel-item"><img src={carousel1} alt="Slide 1" id="sld1" /></div>
        <div className="carousel-item"><img src={carousel2} alt="Slide 2" id="sld2" /></div>
        <div className="carousel-item"><img src={carousel3} alt="Slide 3" id="sld3" /></div>
      </div>
